...
- State hookunu kullanarak bir sayac isimli state oluşturun. 
...
Sayı çift ise ekranda Sayı: 0 çift sayıdır, tek ise Sayı: 1 tek sayıdır 
metni görünecek şekilde kodu düzenle. tek çift için ternary if kullan. 
- Yardımcı fonksiyonları yaz. Tıklandığında sayac'ı bir artırmalı veya azaltmalı. 
Reset'e tıklandığında state'i sıfırlamalı.
 ...
 const artirici = () => {
  ...
  return (
    <div className="widget-counter container">
      <h2>Sayaç</h2>
      <div id="sayici" style={stil}>Sayı: X çift sayıdır</div>
      <div>
