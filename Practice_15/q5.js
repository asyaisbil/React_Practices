...
- success aldığında FETCH_DATA_SUCCESS tipinde bir action dispatch etmeli. payload olarak response'da gelen data'yı vermeli. 
- hata aldığında FETCH_DATA_ERROR tipinde bir action dispatch etmeli. payload olarak error objesindeki message'ı vermeli.
*/
...
export const fetchData = () => (dispatch) => {
    ...
    axios.get("https://api.example.com/data")
        ...
        .catch(error => dispatch({ type: "FETCH_DATA_ERROR", payload: error.message}))
