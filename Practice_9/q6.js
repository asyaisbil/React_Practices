/*
Bir Netflix benzeri platform için bir içerik ekleme formu oluşturuyorsun. Formda bir başlık (zorunlu), bir açıklama (isteğe bağlı) ve bir yayın tarihi (zorunlu) alanları bulunmaktadır. 
